...
public Reservation(){} 
    ...
    public Reservation(String namepart, String usernamepart, String ville, String numtelephonepart, String email_participent) {
    ...
    public String toString() {
        return "Reservation{" + "id=" + id + ", namepart=" + namepart + ", usernamepart=" + usernamepart + ", ville=" + ville + ", numtelephonepart=" + numtelephonepart + ", email_participent=" + email_participent + '}';
    }   
